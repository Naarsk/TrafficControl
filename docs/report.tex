...
the exact MDP is intractable and they use their RVC heuristic; we
...
\begin{figure}[h]
    ...
    ($C_1 = \{1, 3\}$ and $C_2 = \{2, 4\}$), our replication target.
...
which are BLAS-backed). We provide three interchangeable backends,
...
speedup that is verified to be bit-equivalent against the pure-Python
...
0.60 & 6.95  & 6.974  & 6.974  & $+0.024$ & $+0.024$ \\
